  ...
  <body>
    <div id="main">
      ...
      <div style="display: inline-block; text-align:left;">
        <input type="button" id="cancelCallBtn" value="Cancel" onclick="location.href='call_log.html';" />
        <input type="button" id="logCallBtn" value="Log Call" onclick="location.href='call_log.html';" />
      </div>
    </div>
    <div id="left2"></div>
    <div id="right2"></div>
